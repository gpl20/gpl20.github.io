...
//https://github.com/badass-techie/Sonic-Dash-Run
//
/*Known issues:
    Play Again button does nothing 
    Sometimes Sonic stays mid air when jumping (fixed! Many thanks to Ertugrul for the fix)
*/

"use strict";

alert('This is my last code here - I\'m leaving. If you\'re interested in what I\'ll be making in future, find me on GitHub (link in the comments). Wish you guys all the best. Peace.');
